...
return_Data = pd.read_excel(r'C:\Users\rjoosten\PycharmProjects\Event_Study_Final\Stock Price Data Copy.xlsx', index=False)

# CREATE DATETIME OF DATE COLUMN
return_Data['Date'] = pd.to_datetime(return_Data['Date'])

# CREATE LIST OF STOCKS
symbols_list = ['HON', 'HII US Equity', '^GSPC']
...
# DEFINE EVENT DATES ['YEAR-MONTH-DAY']
ED = ['2016-03-02', '2017-01-03', '2018-06-14']
