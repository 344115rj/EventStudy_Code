...
print('Big Data Analytics Capabilities Articles for Honeywell Limited. '
...
while i < len(filenames):
    with open((filenames[i]), 'r') as f:
        for line in f:
            ...
            +sixteenth_count+seventeenth_count
