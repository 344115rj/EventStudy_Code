...
print('Big Data Strategy Articles for Halliburton. '
...
while i < len(filenames):
    with open((filenames[i]), 'r') as f:
        for line in f:
            ...
            print('Strategy is mentioned', third_count, 'time(s)')
